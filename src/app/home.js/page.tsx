import { Fetch } from "@/app/api/coin/market/page"
    ...
    return(
        ...
        <table className="table-auto w-full text-left border-collapse border border-gray-300">
          ...
          <tbody>
            ...
            {coins.map((coin) => (
              <tr key={coin.id}>
                <td className="p-2 border border-gray-300">{coin.market_cap_rank}</td>
                <td className="p-2 border border-gray-300">{coin.name}</td>
                <td className="p-2 border border-gray-300">{coin.current_price.toFixed(2)}</td>
                <td className="p-2 border border-gray-300">{coin.market_cap.toLocaleString()}</td>
                <td
                ...
                <td className="p-2 border border-gray-300">{coin.total_volume.toLocaleString()}</td>
              </tr>
            ))}
          </tbody>
        </table>
